...
var SekindoClientDetections_URL = function (config) {
	...
	this._setObserverChecker = function()
	{
		try
		{
			...
			if (this.placementId == 121289 && ((this.allowViewabilityCheck && (this.ci.browser == 'chrome' || this.ci.browser == 'edgeChromium')) || this.allowUserScrollCheck)) {
				this._setObserverElement();
				this._observerChecker();
			}
			else if (!this.isApp && !this.isAmpProject && !this.isAmpIframe && (this.ci.browser == 'chrome' || this.ci.browser == 'edgeChromium')
		...
		if (type == 'gdpr') {
			...
			this.gppResolve();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=121728&cbuster=1778650177&pubUrl=https%3A%2F%2Fcodebeautify.org%2Fjson-to-html-converter&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1581,1&cbuster=1778650729',
					origQString: 's=121728&cbuster=1778650177&pubUrl=https%3A%2F%2Fcodebeautify.org%2Fjson-to-html-converter&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1581,1',
					placementId: 121728,
					x: 400,
					y: 272,
					videoType: 'slider',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"147.0.0.0","browserVersionMajor":"147","browserVersionMinor":"0","chromeVersion":"147"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'IN',
					dmaCode: 0,
					dynamicSetup: [],
